...
-- ERROR:  null value in column "tag" of relation "table_nn" violates not-null constraint

INSERT INTO table_nn (tag) VALUES (' '); -- this will be added to table
...
INSERT INTO table_email (emails) VALUES ('abc@gmail.com');
...
-- Key (product_code, product_name)=(a, apple) already exists.
